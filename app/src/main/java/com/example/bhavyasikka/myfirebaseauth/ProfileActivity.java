...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mdatabaseReference.child("Names");

        //mfirebaseDatabaseInstance.getReference(uniqueUserId);
        ...
        mUsername.setText("welcome " + user.getEmail());
    ...
    private void saveInfo() {
        ...
        //object of class to store data to firebase

        //UserInformation userInfo= new UserInformation(name,ageUser);

        //to store info of user
